...
<div id="pozadieHlavnaStranka" class="backgroundDefaultFullscreen">
        ...
        <div class="row g-2">
            <div class="col-6 col-md-3 text-center">
                <form method="post" action="{{ route('viewPosts') }}" accept-charset="UTF-8">
                    {{ csrf_field() }}
                    <button class="btn btn-primary w-100" style="margin-bottom:2%; margin-top:2%; background-color: #03203A ">Return to forum</button>
                </form>
            </div>
            <div class="col-6 col-md-3 text-center">
    ...
    <div class="row g-2">
        ...
        <h1 style="background-color: #74889F">{{ $post->post_name }}</h1>
        <p>{{ $post->post_text }}</p>
        <p>Posted by: {{ $post->user->name }}</p>

        <h2 style="background-color: #74889F">Comments</h2>
    ...
    <form method="post" action="{{ route('createComment', ['post'=>$post]) }}" accept-charset="UTF-8">
        {{ csrf_field() }}
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <textarea name="postBody" class="textAreaForTyperacer" style="margin-top: 0" autofocus placeholder="What do you think about this topic?" required></textarea>
                    </div>
